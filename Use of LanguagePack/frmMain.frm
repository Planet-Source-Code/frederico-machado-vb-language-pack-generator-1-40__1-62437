...
Private Sub Command1_Click()
  ...
  cLanguage.LoadPack App.Path & "\packs\" & lstLangPacks.List(lstLangPacks.ListIndex)
...
Private Sub Command5_Click()
    ' Get the String
    MsgBox IIf(cLanguage.GetString("Test") <> "", cLanguage.GetString("Test"), "This is a test string!")
End Sub
