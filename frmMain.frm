...
Private Sub cmdHelp_Click()
    ShellExecute 0, "open", App.Path & "\help\index.htm", "", "", 1
End Sub
...
Private Sub cmdLoad_Click()
  ...
  tvForms.Nodes.Item(1).Selected = True
  ...
  For i = 1 To FormProp(iCurrForm).ObjectNumber
    ...
    ElseIf LCase(FormProp(iCurrForm).objProp(i).Type) = "label" Then
      If Not bAdded(3) Then
        ...
        bAdded(3) = True
      End If
      tvObjects.Nodes.Add "Label", tvwChild, FormProp(iCurrForm).objProp(i).Name, FormProp(iCurrForm).objProp(i).Name
